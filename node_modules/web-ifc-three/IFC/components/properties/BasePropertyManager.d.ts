...
export declare class BasePropertyManager {
    ...
    protected getSpatialNode(modelID: number, node: Node, treeChunks: any, includeProperties?: boolean): void;
    protected getChildren(modelID: number, node: Node, treeChunks: any, propNames: pName, includeProperties?: boolean): void;
