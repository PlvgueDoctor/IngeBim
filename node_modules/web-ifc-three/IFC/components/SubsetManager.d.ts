...
export declare class SubsetManager {
    ...
    dispose(): void;
    getSubset(modelID: number, material?: Material): Mesh<BufferGeometry, Material | Material[]> | null;
    removeSubset(modelID: number, parent?: Object3D, material?: Material): void;
    createSubset(config: HighlightConfigOfModel): void | Mesh<any, Material | Material[]>;
